...
export class TaskService {
  ...
  // }
  public getUser(){
    return this.http.get('https://taskngtool.azurewebsites.net/api/Values/1').map(res=>res.json());
  }

  public getPositionRolesTasks(){
    // return this.http.get('http://localhost:51652/Service1.svc/PositionRoles/?id=100').map(res=>res.json());
    return this.http.get('https://taskngtool.azurewebsites.net/api/Tasks/100').map(res=>res.json());
  }

  public getMaxValueTask(){
    return this.http.get('https://taskngtool.azurewebsites.net/api/Values').map(res=>res.json());
  }
  postTask(record){
    ...
    console.log(record.TaskDetails.TaskName);
      ...
      return this.http.post('https://taskngtool.azurewebsites.net/api/Tasks/',body, requestOptions).map((res:Response)=>res.json());
    ...
    postCustomTask(record){
      ...
      var headerOptions = new Headers({'Content-Type':'application/json'});
      var requestOptions = new RequestOptions({method: RequestMethod.Post, headers:headerOptions});
      return this.http.post('https://taskngtool.azurewebsites.net/api/Values',body,requestOptions).map((res:Response)=>res.json());
    }  
